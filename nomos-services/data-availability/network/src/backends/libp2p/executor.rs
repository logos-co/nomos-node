...
impl<Membership> DaNetworkExecutorBackend<Membership> {
        ...
        + 'static,
{
    ...
    fn new(config: Self::Settings, overwatch_handle: OverwatchHandle) -> Self {
        let (mut validator_swarm, events_streams) =
            ExecutorSwarm::new(config.key, config.membership);
...
async fn handle_validator_events_stream(events_streams: ExecutorEventsStream) {
    let ExecutorEventsStream {
