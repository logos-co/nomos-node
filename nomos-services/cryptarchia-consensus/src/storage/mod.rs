...
pub trait StorageAdapter {
    ...
    /// Sends a store message to the storage service to retrieve the block id of the security block
    ...
    /// # Returns
    ///
    /// The header id of the security block. If no security block is set, returns None.
